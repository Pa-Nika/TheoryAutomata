...
public class Path {
    ...
    public static int max(Deque<Path> stack) {
    ...
    public static Deque<Path> shiftOrCondition(Deque<Path> stack, int shift) {
    ...
    public static Deque<Path> orOp(Deque<Path> stack1, Deque<Path> stack2) {
        ...
        stack.add(p);
        stack2 = shiftOrCondition(stack2, max1 - 1);
        stack.addAll(stack2);
        return stack;
    }
    ...
    public static Deque<Path> sym(CharSymbol s) {
