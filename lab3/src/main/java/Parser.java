...
public class Parser {
    ...
    private final HashSet<Character> N = new HashSet<Character>();
    private final HashSet<Character> T = new HashSet<Character>();
    private final Multimap<String, Character> P = ArrayListMultimap.create();

    public HashSet<Character> readN() {
        String str;
        while (true) {
            boolean flag = false;
            System.out.print("N = ");
    ...
    public HashSet<Character> readT() {
        String str;
        while (true) {
            boolean flag = false;
            boolean flag1 = false;
    ...
    public Multimap<String, Character> readP() {
        String str;
        while (true) {
            boolean flag = false;
            System.out.print("P = ");
